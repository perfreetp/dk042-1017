...
export const enrolledCourses: EnrolledCourse[] = [
  ...
  },
  {
    ...
    checkedAt: '14:00',
    workUploaded: true,
    workImage: 'https://picsum.photos/id/225/400/400',
    reviewSubmitted: true,
    reviewRating: 5,
    reviewContent: '老师非常有耐心，孩子很喜欢这门课，下次还会再来！',
    hasFeedback: true,
    feedbackContent: '小红同学的动手能力很强，作品配色很大胆有创意，继续加油！'
  },
  {
    id: 'e003',
    courseId: 'c001',
...
export const publishedCourses: PublishedCourse[] = [
  ...
  },
  {
    ...
    maxStudents: 6,
    status: 'rejected',
    nextSession: '2026-06-24 10:00',
    rejectReason: '课程介绍过于简略，请补充详细的课程内容和学习目标，并上传更多教学作品图片。'
  }
];
